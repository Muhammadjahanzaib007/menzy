...
class _$StepsDao extends StepsDao {
  _$StepsDao(this.database, this.changeListener)
      : _queryAdapter = QueryAdapter(database),
        ...
        deleteionStepAdapter = DeletionAdapter(
            database,
            'steps_table',
            ['id'],
            (StepsData item) => <String, Object?>{
  ...
  final DeletionAdapter<StepsData> deleteionStepAdapter;
  ...
  @override
  Future<void> deleteData(List<StepsData> data)async {
     await deleteionStepAdapter.deleteList(data);
  }
}
